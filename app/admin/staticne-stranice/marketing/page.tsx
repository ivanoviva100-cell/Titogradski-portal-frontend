...
export default function UrediMarketing() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await sacuvajStaticnuStranicu('marketing', sadrzaj);
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto text-slate-200">
      ...
      <h1 className="text-xl sm:text-2xl font-bold mb-6">Uređivanje stranice: Marketing</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={cuvanje}
          className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 text-white font-medium rounded-lg transition-colors shadow-sm text-sm"
        >
