...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-white border-b border-gray-200 shadow-sm">
      ...
      {/* 3. Navigaciona traka (Povećana visina, font i logo) */}
      <nav className="bg-gray-100 text-gray-800 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 flex items-center space-x-8 overflow-x-auto py-4 text-sm font-extrabold tracking-wide">
          ...
          {/* Rubrike sa većim fontom i razmakom */}
          {rubrike.map((item) => (
            <Link 
              key={item.path} 
              href={item.path} 
